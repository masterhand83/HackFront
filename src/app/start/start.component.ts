...
export class StartComponent implements OnInit {
  ...
  constructor() {
    ...
    this.lineas.push({id: 'linea_AA', nombre: 'Linea 10', image: '/assets/images/lineaa-500x500-500x500.png'});
    this.lineas.push({id: 'linea_AB', nombre: 'Linea 11', image: 'assets/images/lineab-500x500-500x500.png'});
